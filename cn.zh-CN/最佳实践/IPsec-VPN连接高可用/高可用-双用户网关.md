...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801041592_zh-CN.png)
...
**说明：** 本选项只有在选择开启了SSL-VPN功能后才可配置。
    ...
    -   **计费周期**：选择购买时长。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801041710_zh-CN.png)
...
5.  在创建用户网关页面，单击**+添加**添加另一用户网关。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801141711_zh-CN.png)
...
4.  根据以下信息配置IPsec连接，然后单击**确定**。
    ...
    -   **健康检查**：开启健康检查并输入目的IP、源IP、重试间隔和重试次数。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801141712_zh-CN.png)

5.  在弹出的对话框中单击**确定**。
6.  找到目标路由条目，单击**发布**，然后在弹出的对话框中单击**确定**。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801141713_zh-CN.png)
...
3.  找到目标IPsec连接，然后单击**下载配置**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801141714_zh-CN.png)
...
4.  根据本地网关设备的配置要求，将下载的配置添加到本地网关设备中。详细说明，请参见[本地网关配置](../../../../../intl.zh-CN/用户指南/配置IPsec-VPN/本地网关配置/华为防火墙配置.md#)。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/155468801141715_zh-CN.png)
