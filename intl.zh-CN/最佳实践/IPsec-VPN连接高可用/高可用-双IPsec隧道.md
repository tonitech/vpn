...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136912/156162261641844_zh-CN.png)
...
5.  在创建用户网关页面，单击**+添加**添加另一用户网关。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/156162261641711_zh-CN.png)
...
3.  找到目标IPsec连接，然后单击**下载配置**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/156162261641714_zh-CN.png)
...
4.  根据本地网关设备的配置要求，将下载的配置添加到本地网关设备中。详细说明，请参见[本地网关配置](../intl.zh-CN/用户指南/配置IPsec-VPN/本地网关配置/华为防火墙配置.md#)。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/136913/156162261641715_zh-CN.png)
